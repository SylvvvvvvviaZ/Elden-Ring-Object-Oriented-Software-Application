 ...
 * @version 1.0
 */
public enum CombatArchetypeEnum {
    SAMURAI {
        @Override
    ...
    public static CombatArchetypeEnum askForClass(Display display) {
        // Print out every archetype available
        for (CombatArchetypeEnum archetype : CombatArchetypeEnum.values()) {
        ...
        for (int i = 0; i < CombatArchetypeEnum.values().length; i++) {
            archetypeOptions.add(CombatArchetypeEnum.values()[i].getHotKey());
        }
